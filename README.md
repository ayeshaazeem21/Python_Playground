...
A collection of Python scripts I'm writing while learning — mixing my own practice code with exercises from the [Codedex](https://www.codedex.io/) Python course.
...
Feel free to check out my other projects on [GitHub](https://github.com/ayeshaazeem21).
